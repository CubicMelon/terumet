...
local function reg_terumet_armor(data)
    ...
    armor:register_armor(boots_id, {
        description = terumet.description(data.name..' Boots', data.xinfo),
    ...
    armor:register_armor(helm_id, {
        description= terumet.description(data.name..' Helmet', data.xinfo),
    ...
    armor:register_armor(chest_id, {
        description= terumet.description(data.name..' Chestpiece', data.xinfo),
    ...
    armor:register_armor(legs_id, {
        description= terumet.description(data.name..' Leggings', data.xinfo),
...
if opts.BRACERS then
    ...
    local function reg_terumet_band(data)
        ...
        armor:register_armor(band_id, {
            description= terumet.description(data.name..' Bracers', data.xinfo),
