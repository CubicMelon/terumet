...
TEXTURE_FILES = [
    ...
    [None, MT('ingot_alloy_tcop'), MT('block_alloy_tcop'), MT('tool_pick_tcop'), MT('tool_shovel_tcop'), MT('tool_axe_tcop'), MT('tool_sword_tcop')],
    [None, MT('ingot_alloy_tste'), MT('block_alloy_tste'), MT('tool_pick_tste'), MT('tool_shovel_tste'), MT('tool_axe_tste'), MT('tool_sword_tste')],
    [None, MT('ingot_alloy_tgol'), MT('block_alloy_tgol'), MT('tool_pick_tgol'), MT('tool_shovel_tgol'), MT('tool_axe_tgol'), MT('tool_sword_tgol')],
