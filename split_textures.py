...
TEXTURE_FILES = [
    ...
    [MT('lump_raw'), MT('ingot_raw'), MT('block_raw'), MT('tool_pick_raw'), MT('tool_shovel_raw'), MT('tool_axe_raw'), MT('tool_sword_raw')],
    [MT('item_coil'), MT('ingot_tcop'), MT('block_tcop'), MT('tool_pick_tcop'), MT('tool_shovel_tcop'), MT('tool_axe_tcop'), MT('tool_sword_tcop')],
